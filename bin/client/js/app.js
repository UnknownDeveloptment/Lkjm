...
/***/function (module, exports, __webpack_require__) {
	...
	var ChatClient = __webpack_require__(51);
	...
	function drawFood(food) {
		...
		drawCircle(food.x - player.x + global.screenWidth / 2, food.y - player.y + global.screenHeight / 2, food.radius, global.foodSides);
	}
	...
	function drawVirus(virus) {
		...
		drawCircle(virus.x - player.x + global.screenWidth / 2, virus.y - player.y + global.screenHeight / 2, virus.radius, global.virusSides);
	}
		...
		for (var z = 0; z < order.length; z++) {
			...
			for (var i = 0; i < points; i++) {
				...
				if (typeof userCurrent.id == "undefined") {
					...
					x = valueInRange(-cellCurrent.x - player.x + global.screenWidth / 2 + cellCurrent.radius / 3, global.gameWidth - cellCurrent.x + global.gameWidth - player.x + global.screenWidth / 2 - cellCurrent.radius / 3, x);
					y = valueInRange(-cellCurrent.y - player.y + global.screenHeight / 2 + cellCurrent.radius / 3, global.gameHeight - cellCurrent.y + global.gameHeight - player.y + global.screenHeight / 2 - cellCurrent.radius / 3, y);
				}
...
/***/function (module, exports, __webpack_require__) {
	...
	var ChatClient = function () {
		...
		_createClass(ChatClient, [{
			...
			key: 'toggleContinuity',
			value: function toggleContinuity() {
			...
			key: 'toggleRoundFood',
			value: function toggleRoundFood(args) {
